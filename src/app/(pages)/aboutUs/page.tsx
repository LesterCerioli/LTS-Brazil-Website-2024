  ...
  return (
    <S.Container>
      ...
      <div className="frist-second">
        <S.Section>
          <Image src={EscritorioImage.src} alt="Time Lucas(imagem ilustrativa)" width={600} height={250} />
          <S.SectionContent>
            <p>
